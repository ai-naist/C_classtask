...
inline void plot_opt(const int start, const int N, FILE **gpp, const CityInfo_t *data, const int *zz)
{
    fprintf(*gpp, "set multiplot\n");
    FILE *fp_opt;
    ...
    fprintf(*gpp, "plot 'point.dat' with points pointtype 6 pointsize 1.5 linetype rgbcolor 'black'\n");
    fflush(*gpp);
    fprintf(*gpp, "plot 'optplot.dat' with lines linetype rgbcolor 'web-green' linewidth 2\n");
    fclose(fp_opt);
    fflush(*gpp);
    Sleep(1000);
}
